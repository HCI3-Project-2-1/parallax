...
ref_image_path = "Face_detection/Distance_estimator/reference_image1.png"
ref_image = cv.imread(ref_image_path)

if ref_image is None:
    print(f"Error: Could not read the reference image file '{ref_image_path}'")
    print(f"Current working directory: {os.getcwd()}")
    print(f"Absolute path to the file: {os.path.abspath(ref_image_path)}")
